...
public final class gameapp extends gamebase {
	...
	public final void init() {
		...
		lightGray = (int) (super.view_width * 0.25F);
		min = (int) (super.view_height * 0.25F);
		...
		random = length + min / 2;
		red = lightGray / super.sC;
		repaint = min / super.aC;
		super.AB = null;
		super.EB = 0;
		super.GB = 1;
		repaint();
	...
	public final void I() {
		...
		if (nobj != null && ((oGameObject) (nobj)).s >= 0 && (nobj).QI == 4) {
			if (gZ > 0) {
				gZ--;
				if (gZ == 0)
					eZ = 0;
	...
	public final void I(surface surf_dest) {
		...
		if (super.pC) {
			...
			surf_dest.I(keyUp, length, lightGray, min, Constant.c_dkgreen_int, 1);
			...
			surf_dest.I(l2 - 1, i3 - 1, 3, 3, Constant.c_green_int);
			int j3 = (int) ((super.view_width * red) / 2.0F);
			int l3 = (int) ((super.view_height * red) / 2.0F);
			int j4 = l2 + j3;
			int l4 = i3 + l3;
			l2 -= j3;
			i3 -= l3;
			surf_dest.I(l2, i3, 2, 5, Constant.c_green_int);
			surf_dest.I(l2 + 2, i3, 3, 2, Constant.c_green_int);
			surf_dest.I(j4 - 1, i3, 2, 5, Constant.c_green_int);
			surf_dest.I(j4 - 4, i3, 3, 2, Constant.c_green_int);
			surf_dest.I(l2, l4 - 4, 2, 5, Constant.c_green_int);
			surf_dest.I(l2 + 2, l4 - 1, 3, 2, Constant.c_green_int);
			surf_dest.I(j4 - 1, l4 - 4, 2, 5, Constant.c_green_int);
			surf_dest.I(j4 - 4, l4 - 1, 3, 2, Constant.c_green_int);
			F(surf_dest, EC, false, 3, 3, Constant.c_ltgray_int, Constant.c_dkgray_int);
			F(surf_dest, vZ, false, 3, 3, Constant.c_ltgray_int, Constant.c_dkgray_int);
			F(surf_dest, wZ, false, 3, 3, Constant.c_red_int, Constant.c_maroon_int);
			F(surf_dest, GC, false, 3, 3, Constant.c_red_int, Constant.c_maroon_int);
			F(surf_dest, BC, true, 3, 3, Constant.c_lemon_int, Constant.c_dkyellow_int);
		}
		super.I(surf_dest);
	}
