...
final class gameobjectivelist
{
    ...
    final void Z()
    {
        if(M > 0)
        {
            ...
            if(L == 0)
            {
                HNSM(Math.max(1, (int)Math.round((double)O - Math.random())));
                L = (int)(Math.random() * (double)N) + M;
            }
        }
        if(random >= 0)
        {
            ...
            if(random <= 0)
            {
                ...
                if(height == 2)
                {
                    ...
                    for(int j = 0; j < l && (width == -1 || i < width); j++)
                    {
                        ...
                        oSpaceship oSpaceship1 = (oSpaceship)(j < 0 || j >= oGameObjectlist2.C ? null : oGameObjectlist2.Z[j]);
                ...
                } else
                {
                    ...
                    for(int k = 0; k < i1 && (width == -1 || i < width); k++)
                    {
                        ...
                        oSpaceship oSpaceship2 = (oSpaceship)(k < 0 || k >= oGameObjectlist4.C ? null : oGameObjectlist4.Z[k]);
                ...
                if(i == 0)
                    ...
                    random = x + (int)(Math.random() * (double)y);
            }
        }
        for(boolean flag = true; flag && C < Z;)
        {
            ...
            case 4: // '\004'
                if(height == 2)
                {
                    if(HNSM.vZ.I(gameobjective1.J, gameobjective1.S, gameobjective1.A, gameobjective1.E, gameobjective1.G, 0.0001F) == null && HNSM.EC.I(gameobjective1.J, gameobjective1.S, gameobjective1.A, gameobjective1.E, gameobjective1.G, 0.0001F) == null)
                        flag = true;
                } else
                if(HNSM.wZ.I(gameobjective1.J, gameobjective1.S, gameobjective1.A, gameobjective1.E, gameobjective1.G, 0.0001F) == null && HNSM.GC.I(gameobjective1.J, gameobjective1.S, gameobjective1.A, gameobjective1.E, gameobjective1.G, 0.0001F) == null)
                    flag = true;
                break;
    ...
    {
        int j = (int)(Math.random() * (double)T);
        for(int l = 0; l < R; l++)
        {
            if(j <= U[l])
            {
                ...
                if(Q == 0)
                {
                    ...
                    case 0: // '\0'
                        f = ((gamebase) (HNSM)).YC;
                        f1 = ((gamebase) (HNSM)).zC + (int)(Math.random() * (double)((gamebase) (HNSM)).aC);
                        break;
                    ...
                    case 2: // '\002'
                        f = ((gamebase) (HNSM)).YC + (int)(Math.random() * (double)((gamebase) (HNSM)).sC);
                        f1 = ((gamebase) (HNSM)).cC;
                        break;
                ...
                {
                    int j1 = (int)(Math.random() * (double)Q * 0.99998998641967773D);
                    Rectangle rectangle = P[j1];
                    f = (float)((double)rectangle.x + Math.random() * (double)rectangle.width);
                    f1 = (float)((double)rectangle.y + Math.random() * (double)rectangle.height);
                }
                ...
                if(K >= 0.0F)
                    oSpaceship1.BI = K;
                oSpaceship1.I(f, f1, null, f + 1.0F, f1 + 1.0F, W[l] * ((gamebase) (HNSM)).view_scale, 1.0F, 0.15F, true);
                oSpaceship1.E();
