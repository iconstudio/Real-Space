...
final class sprite {
	...
	public static final sprite I(float f, float f1, int i, int j, int k, int l, int i1, int j1, int k1,
		...
		int l2 = Math.round(((float) (-j2) - 1.0F) * f5 - ((float) (-k2) - 1.0F) * f4);
		int j3 = Math.round(((float) (-j2) - 1.0F) * f4 + ((float) (-k2) - 1.0F) * f5);
		int l3 = Math.round(((float) j2 + 1.0F) * f5 - ((float) (-k2) - 1.0F) * f4);
		int j4 = Math.round(((float) j2 + 1.0F) * f4 + ((float) (-k2) - 1.0F) * f5);
		int l4 = -l2;
		int i5 = -j3;
		int j5 = -l3;
		int k5 = -j4;
		...
		float f8 = Math.round((float) l5 * f7 - (float) j6 * f6);
		float f9 = Math.round((float) l5 * f6 + (float) j6 * f7);
		f8 += j2;
		f9 += k2;
		int l12 = imagepixels1.I;
		for (int i9 = 0; i9 < i7; i9++) {
			...
			for (int k8 = 0; k8 < l6; k8++) {
				...
				if (i3 >= 0 && i4 < l1 && k3 >= 0 && k4 < i2) {
					...
					if (k3 >= 0) {
						if (i3 >= 0) {
							k10 = imagepixels1.Z[k9];
							if (k10 == j7 || (k10 & 0xff000000) == 0)
								k10 = 0;
						}
						if (i4 < l1) {
							l10 = imagepixels1.Z[k9 + 1];
					...
					if (k4 < i2) {
						if (i3 >= 0) {
							i11 = imagepixels1.Z[k9];
							if (i11 == j7 || (i11 & 0xff000000) == 0)
								i11 = 0;
						}
						if (i4 < l1) {
							j11 = imagepixels1.Z[k9 + 1];
							if (j11 == j7 || (j11 & 0xff000000) == 0)
								j11 = 0;
						}
					}
					if (k10 != 0 || l10 != 0 || i11 != 0 || j11 != 0) {
						float f16 = f10 - (float) (int) f10;
						float f17 = f11 - (float) (int) f11;
						float f12 = (1.0F - f16) * (1.0F - f17);
						float f14 = f16 * (1.0F - f17);
						float f13 = (1.0F - f16) * f17;
						float f15 = f16 * f17;
						int k11 = (int) (f12 * (float) (k10 >>> 24 & 0xff) + f13 * (float) (i11 >>> 24 & 0xff)
								+ f14 * (float) (l10 >>> 24 & 0xff) + f15 * (float) (j11 >>> 24 & 0xff));
						if (k11 != 0) {
							if (k11 > 200)
								k11 = 255;
							int i12 = (int) (f12 * (float) (k10 >> 16 & 0xff) + f13 * (float) (i11 >> 16 & 0xff)
									+ f14 * (float) (l10 >> 16 & 0xff) + f15 * (float) (j11 >> 16 & 0xff));
							int j12 = (int) (f12 * (float) (k10 >> 8 & 0xff) + f13 * (float) (i11 >> 8 & 0xff)
									+ f14 * (float) (l10 >> 8 & 0xff) + f15 * (float) (j11 >> 8 & 0xff));
							int k12 = (int) (f12 * (float) (k10 & 0xff) + f13 * (float) (i11 & 0xff)
									+ f14 * (float) (l10 & 0xff) + f15 * (float) (j11 & 0xff));
		...
		i8++;
		j8++;
		float f18 = (float) j1 * f5 - (float) k1 * f4;
		float f19 = (float) j1 * f4 + (float) k1 * f5;
		int i13 = Math.round(f18 + (float) (k7 - (l6 - 1 - i8)) / 2.0F);
		int j13 = Math.round(f19 + (float) (l7 - (i7 - 1 - j8)) / 2.0F);
		if (i > 0) {
