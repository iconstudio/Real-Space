            ...
            if(i >= 0 && i + sprite1.C < I && j >= 0 && j + sprite1.B < Z)
            {
                ...
                for(int k = 0; k < l7; k++)
                {
                    ...
                    for(int i1 = 0; i1 < word0;)
                    {
                        ...
                        int j7 = i4 & 0xff;
                        int l6 = k3 & 0xff;
                        B[l1] = (k4 * (j5 - l4) >> 8) + l4 << 16 | (k4 * (j6 - l5) >> 8) + l5 << 8 | (k4 * (j7 - l6) >> 8) + l6;
                        i1++;
                        l1++;
                    }
                ...
                if(l2 >= 0 && l2 < Z)
                {
                    ...
                    if(j2 < I && k2 >= 0)
                    {
                        ...
                        for(int j3 = i2 + i3; i2 < j3; i2++)
                        {
                            ...
                            int k7 = j4 & 0xff;
                            int i7 = l3 & 0xff;
                            B[k1] = (k4 * (k5 - i5) >> 8) + i5 << 16 | (k4 * (k6 - i6) >> 8) + i6 << 8 | (k4 * (k7 - i7) >> 8) + i7;
                            k1++;
                        }
                ...
                for(int k = 0; k < i8; k++)
                {
                    ...
                    for(int i1 = 0; i1 < word0;)
                    {
                        ...
                        } else
                        {
                            ...
                            int k7 = i4 & 0xff;
                            int i7 = k3 & 0xff;
                            B[l1] = (k4 * (k5 - i5) >> 8) + i5 << 16 | (k4 * (k6 - i6) >> 8) + i6 << 8 | (k4 * (k7 - i7) >> 8) + i7;
                        }
                        i1++;
                        l1++;
                    }
                    ...
                    if(j2 < I && k2 >= 0)
                    {
                        ...
                        for(int j3 = i2 + i3; i2 < j3; i2++)
                        {
                            ...
                            } else
                            {
                                ...
                                int l7 = j4 & 0xff;
                                int j7 = l3 & 0xff;
                                B[k1] = (l4 * (l5 - j5) >> 8) + j5 << 16 | (l4 * (l6 - j6) >> 8) + j6 << 8 | (l4 * (l7 - j7) >> 8) + j7;
                            }
                            k1++;
                        }
