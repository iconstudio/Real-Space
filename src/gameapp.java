...
public final class gameapp extends gamebase {
	/**
	 * 
	 */
	...
	public final void init() {
		...
		super.init();
		super.BB = "Realspace 2 - Emperor's Revenge";
		super.app_name = "realspace2";
		...
		PC = -1;
		QC = 1;
		nZ = 12F * super.view_scale;
		getAppletContext = (int) (220F * super.view_scale);
		...
		I((-5000F * super.view_scale) / 2.0F, (5000F * super.view_scale) / 2.0F, (-5000F * super.view_scale) / 2.0F,
				(5000F * super.view_scale) / 2.0F);
		fZ = super.bC + super.screen_width / 2.0F + 200F;
		jZ = super.dC - super.screen_width / 2.0F - 200F;
		sZ = super.fC + super.screen_height / 2.0F + 200F;
		aZ = super.jC - super.screen_height / 2.0F - 200F;
		lightGray = (int) ((float) super.view_width * 0.25F);
		min = (int) ((float) super.view_height * 0.25F);
		lightGray = Math.min(lightGray, min);
		min = lightGray;
		out = lightGray / 6;
		pink = min / 6;
		keyUp = super.view_width - lightGray - (int) (40F * super.view_scale);
		length = super.view_height - min - (int) (50F * super.view_scale);
		println = keyUp + lightGray / 2;
		random = length + min / 2;
		red = (float) lightGray / super.sC;
		repaint = (float) min / super.aC;
		super.AB = null;
		super.EB = 0;
		super.GB = 1;
		repaint();
	...
	public final void I() {
		...
		oSpaceship nobj = (oSpaceship) (((oGameObjectlist) (obj)).C <= 0 ? null : ((oGameObjectlist) (obj)).Z[0]);
		if (nobj != null && ((oGameObject) (nobj)).s >= 0 && ((oSpaceship) (nobj)).QI == 4) {
			if (gZ > 0) {
				gZ--;
				if (gZ == 0)
					eZ = 0;
			...
			if (!super.pC) {
				if (getCodeBase != 1 && super.qC) {
					if (getCodeBase == 2) {
						float f1 = (float) Math.cos(((oGameObject) (nobj)).Y);
						float f3 = (float) Math.sin(((oGameObject) (nobj)).Y);
						nobj.W = f1 * ((oGameObject) (nobj)).N;
						nobj.X = f3 * ((oGameObject) (nobj)).N;
					} else {
						float f2 = (float) (-Math.cos(((oGameObject) (nobj)).Y));
						float f4 = (float) (-Math.sin(((oGameObject) (nobj)).Y));
						nobj.W = f2 * ((oGameObject) (nobj)).N * 0.3F;
						nobj.X = f4 * ((oGameObject) (nobj)).N * 0.3F;
					}
					nobj.K += ((oGameObject) (nobj)).W;
					nobj.L += ((oGameObject) (nobj)).X;
				} else {
					nobj.W = 0.0F;
					nobj.X = 0.0F;
				}
				if (getBackground != 1) {
					if (getBackground == 2) {
						...
						if (getRGB > 0.1963495F)
							getRGB = 0.1963495F;
						nobj.Y += getRGB;
						if (((oGameObject) (nobj)).Y >= 6.283185F)
							nobj.Y -= 6.283185F;
					}
					nobj.d = ((oGameObject) (nobj)).x.I(((oGameObject) (nobj)).Y);
				}
			} else if (super.qC && Math.random() * 10D > 9D)
				abs();
			if (((oGameObject) (nobj)).J <= fZ) {
				if (((oGameObject) (nobj)).K < 0.0F)
					nobj.K = 0.0F;
				nobj.J = fZ;
				((oGameObject) (nobj)).F();
			} else if (((oGameObject) (nobj)).J >= jZ) {
				if (((oGameObject) (nobj)).K > 0.0F)
					nobj.K = 0.0F;
				nobj.J = jZ;
				((oGameObject) (nobj)).F();
			}
			if (((oGameObject) (nobj)).S <= sZ) {
				if (((oGameObject) (nobj)).L < 0.0F)
					nobj.L = 0.0F;
				nobj.S = sZ;
				((oGameObject) (nobj)).F();
			} else if (((oGameObject) (nobj)).S >= aZ) {
				if (((oGameObject) (nobj)).L > 0.0F)
					nobj.L = 0.0F;
				nobj.S = aZ;
				((oGameObject) (nobj)).F();
		...
		Starfield.update(((oGameObject) (Camera)).K, ((oGameObject) (Camera)).L);
		super.I();
		Mission.I();
		dZ.Z();
		oZ.Z();
	...
	public final void I(surface surface1) {
		surface surface2 = super.lC;
		surface surface3 = super.mC;
		System.arraycopy(surface3.B, 0, surface2.B, 0, surface2.C);
		if (!super.SB) {
			int i1 = (super.view_width - 200) / 2;
			int i2 = (super.view_height - 200) / 2;
			if (blue != null)
				surface1.I(blue, i1, i2, this);
			if (super.GB > 0) {
				i1 += 6;
				i2 += 147;
				gameutil.I(surface1, i1, i2, 188, 20, (float) super.EB / (float) super.GB, 0xff4040ff,
						Constant.c_green_int);
			}
			return;
		}
		if (!keyDown)
			keyDown = true;
		Starfield.draw(surface1);
		AC.I(surface1);
		EC.I(surface1);
		GC.I(surface1);
		if (!super.pC && NC) {
			int j1 = (int) (20F * super.view_scale);
			int j2 = (int) (25F * super.view_scale);
			surface1.I(super.uC, Constant.c_white_int, super.hFontSmall, j1 - 1, j2 + 1);
			Object obj = dZ;
			...
			if (obj != null && ((oGameObject) (obj)).e == 1) {
				...
				surface1.I("Damage", Constant.c_white_int, super.hFontSmall, k1 - 1, j2 + 1);
				...
				if (f1 < MC)
					...
					if (f1 - MC > 0.01F)
						...
						MC = f1;
				Object obj1;
				gameutil.I(surface1, k1, j2 + 2, getAppletContext, ((gamefont) (obj1 = super.eC)).C - 4, MC,
						Constant.c_red_int, Constant.c_yellow_int);
				surface1.I(k1, j2, getAppletContext, ((gamefont) (obj1 = super.eC)).C, Constant.c_dkgreen_int, 1);
				int k3 = (int) (35F * super.view_scale);
				int i4 = (int) (20F * super.view_scale);
				int k4 = i4 + (int) (48F * super.view_scale);
				float f2 = Math.abs((float) (super.IB % 22L) - 11F) * 0.059F + 0.35F;
				j2 = (int) ((float) super.view_height * 0.7F);
				if (hZ == 1)
					surface1.I(arraycopy.I(0, 0), f2, i4, j2, this);
				else
					surface1.I(arraycopy.I(0, 0), i4, j2, this);
				surface1.I("-", Constant.c_white_int, super.eC, k4, j2 + super.eC.C + 2);
				j2 += k3;
				obj1 = String.valueOf(kZ);
				if (hZ == 2)
					surface1.I(arraycopy.I(1, 0), f2, i4, j2, this);
				else
					surface1.I(arraycopy.I(1, 0), i4, j2, this);
				surface1.I(((String) (obj1)), Constant.c_white_int, super.eC, k4, j2 + super.eC.C + 2);
				j2 += k3;
				obj1 = String.valueOf(lZ);
				if (hZ == 3)
					surface1.I(arraycopy.I(2, 0), f2, i4, j2, this);
				else
					surface1.I(arraycopy.I(2, 0), i4, j2, this);
				surface1.I(((String) (obj1)), Constant.c_white_int, super.eC, k4, j2 + super.eC.C + 2);
				j2 += k3;
				obj1 = String.valueOf(mZ);
				if (hZ == 4)
					surface1.I(arraycopy.I(3, 0), f2, i4, j2, this);
				else
					surface1.I(arraycopy.I(3, 0), i4, j2, this);
				surface1.I(((String) (obj1)), Constant.c_white_int, super.eC, k4, j2 + super.eC.C + 2);
			}
			surface1.I(keyUp, length, lightGray, min, getBackground().getRGB());
		}
		vZ.I(surface1);
		wZ.I(surface1);
		dZ.I(surface1);
		...
		BC.I(surface1);
		if (super.pC) {
			surface1.I("Click Anywhere Or Press Any Key To Start", Color.red.getRGB(), super.hFontSmall,
					super.view_width / 2 - super.hFontSmall.I("Click Anywhere Or Press Any Key To Start") / 2 - 1,
					super.view_height / 8 + 1);
			surface1.I("Click Anywhere Or Press Any Key To Start", Color.yellow.getRGB(), super.hFontSmall,
			...
			int k2 = keyUp + out;
			for (; l1 < 6; l1++) {
				surface1.I(k2, length, 1, min, 0xff004000);
				k2 += out;
			}
			...
			k2 = length + pink;
			for (; l1 < 6; l1++) {
				surface1.I(keyUp, k2, lightGray, 1, 0xff004000);
				k2 += pink;
			}

			surface1.I(keyUp, length, lightGray, min, Constant.c_dkgreen_int, 1);
			surface1.I(black.I(0, 0), keyUp + (lightGray - black.C) / 2, length + min + 2, this);
			int l2 = println + (int) (((oGameObject) (Camera)).J * red);
			int i3 = random + (int) (((oGameObject) (Camera)).S * repaint);
			surface1.I(l2 - 1, i3 - 1, 3, 3, Constant.c_green_int);
			int j3 = (int) (((float) super.view_width * red) / 2.0F);
			int l3 = (int) (((float) super.view_height * red) / 2.0F);
			int j4 = l2 + j3;
			int l4 = i3 + l3;
			l2 -= j3;
			i3 -= l3;
			surface1.I(l2, i3, 2, 5, Constant.c_green_int);
			surface1.I(l2 + 2, i3, 3, 2, Constant.c_green_int);
			surface1.I(j4 - 1, i3, 2, 5, Constant.c_green_int);
			surface1.I(j4 - 4, i3, 3, 2, Constant.c_green_int);
			surface1.I(l2, l4 - 4, 2, 5, Constant.c_green_int);
			surface1.I(l2 + 2, l4 - 1, 3, 2, Constant.c_green_int);
			surface1.I(j4 - 1, l4 - 4, 2, 5, Constant.c_green_int);
			surface1.I(j4 - 4, l4 - 1, 3, 2, Constant.c_green_int);
			F(surface1, EC, false, 3, 3, Constant.c_ltgray_int, Constant.c_dkgray_int);
			F(surface1, vZ, false, 3, 3, Constant.c_ltgray_int, Constant.c_dkgray_int);
			F(surface1, wZ, false, 3, 3, Constant.c_red_int, Constant.c_maroon_int);
			F(surface1, GC, false, 3, 3, Constant.c_red_int, Constant.c_maroon_int);
			F(surface1, BC, true, 3, 3, Constant.c_lemon_int, Constant.c_dkyellow_int);
		}
		super.I(surface1);
	}
	...
	public final void F(surface surface1, oGameObjectlist oGameObjectlist1, boolean flag, int i1, int j1, int k1,
		...
		for (int i3 = 0; i3 < oGameObjectlist1.C; i3++) {
			oGameObject oGameObject1 = oGameObjectlist1.Z[i3];
		...
		if (init != 0 && !super.pC) {
			...
			case 3: // '\003'
				...
				for (int i1 = 0; i1 < k1; i1++) {
					oGameObjectlist4 = vZ;
					oGameObject oGameObject1 = i1 < 0 || i1 >= oGameObjectlist4.C ? null : oGameObjectlist4.Z[i1];
				...
				for (int j1 = 0; j1 < k1; j1++) {
					...
					oGameObject oGameObject2 = j1 < 0 || j1 >= oGameObjectlist5.C ? null : oGameObjectlist5.Z[j1];
	...
	public final boolean keyDown(Event event, int i1) {
		...
		if (!super.oC && super.SB)
			if (super.pC)
				...
				if ((super.CB[2] == 70 || super.CB[2] == 102) && (super.CB[1] == 82 || super.CB[1] == 114)
						&& (super.CB[0] == 89 || super.CB[0] == 121))
					init = 1;
				else if ((super.CB[2] == 89 || super.CB[2] == 121) && (super.CB[1] == 79 || super.CB[1] == 111)
						&& (super.CB[0] == 87 || super.CB[0] == 119))
					init = 5;
				else if ((super.CB[2] == 70 || super.CB[2] == 102) && (super.CB[1] == 73 || super.CB[1] == 105)
						&& (super.CB[0] == 88 || super.CB[0] == 120))
					init = 2;
				else if ((super.CB[3] == 66 || super.CB[3] == 98) && (super.CB[2] == 65 || super.CB[2] == 97)
						&& (super.CB[1] == 75 || super.CB[1] == 107) && (super.CB[0] == 69 || super.CB[0] == 101))
					init = 3;
				else if ((super.CB[2] == 75 || super.CB[2] == 107) && (super.CB[1] == 65 || super.CB[1] == 97)
						&& (super.CB[0] == 84 || super.CB[0] == 116))
					init = 4;
			}
		return true;
	}
	...
	public final boolean mouseDown(Event event, int i1, int j1) {
		if (!super.oC && super.SB)
			if (super.pC) {
				boolean flag = false;
				gametext gametext2 = (gametext) super.vC.I(i1, j1);
				if (gametext2 != null && ((oGameObject) (gametext2)).HI == 3) {
					flag = true;
					try {
						getAppletContext().showDocument(
								new URL(super.FB + "?game=realspace2&refer=" + getCodeBase() + super.JB), "_blank");
				...
				gametext gametext1 = (gametext) super.vC.I(i1, j1);
				if (gametext1 != null)
					J(((oGameObject) (gametext1)).HI);
			}
		return true;
	}

	public final boolean mouseMove(Event event, int i1, int j1) {
		if (!super.oC && super.SB && (Mission.O == 300 || Mission.O == 301 || Mission.O == 302)) {
			gametext gametext1 = (gametext) super.vC.I(i1, j1);
			if (gametext1 != null)
				I(((oGameObject) (gametext1)).HI);
		}
		return true;
	}
	...
	final void I(int i1) {
		...
		for (int k1 = 0; k1 < j1; k1++) {
			Object obj = super.vC;
			obj = (gametext) (k1 < 0 || k1 >= ((oGameObjectlist) (obj)).C ? null : ((oGameObjectlist) (obj)).Z[k1]);
			if (obj != null && ((oGameObject) (obj)).HI != -1 && ((oGameObject) (obj)).HI == i1)
				flag = true;
		}
		...
		if (flag) {
			...
			for (int l1 = 0; l1 < j1; l1++) {
				...
				gametext nobj = (gametext) (l1 < 0 || l1 >= obj1.C ? null : obj1.Z[l1]);
				if (nobj != null && ((oGameObject) (nobj)).HI != -1)
					if (((oGameObject) (nobj)).HI == i1) {
						palette palette1 = darker;
						palette palette2 = freeMemory;
						nobj.D = palette1;
						nobj.LI = palette2;
					} else {
						nobj.D = ((gametext) (nobj)).MI;
						nobj.LI = ((gametext) (nobj)).NI;
					}
			}
	...
	final void abs() {
		oGameObjectlist obj = dZ;
		oSpaceship nobj = (oSpaceship) (obj.C <= 0 ? null : obj.Z[0]);
		if (nobj != null && ((oGameObject) (nobj)).s >= 0 && nobj.QI == 4 && !nobj.Z) {
			nobj.J();
			nobj.Z = true;
			nobj.C = 5;
			nobj.B = 0;
	...
	final boolean load_resource() {
		...
		l2 = k2++;
		super.AB = "Loading And Preparing Resources";
		super.EB = l2;
		super.GB = 112;
		repaint();
		imagepixels1.Z = null;
		...
		Object obj = G;
		float f1 = super.view_scale, factor;
		...
		arraycopy(k, super.view_scale, 3, 4, 55, 22, imagepixels1, 32, 0, 32);
		obj = k2++;
		super.AB = "Loading And Preparing Resources";
		super.EB = ((int) (obj));
		super.GB = 112;
		...
		arraycopy(l, super.view_scale, 3, 5, 91, 21, imagepixels1, 32, 0, 32);
		obj = k2++;
		super.AB = "Loading And Preparing Resources";
		super.EB = ((int) (obj));
		super.GB = 112;
		...
		arraycopy(m, super.view_scale, 3, 7, 123, 27, imagepixels1, 32, 0, 32);
		obj = k2++;
		super.AB = "Loading And Preparing Resources";
		super.EB = ((int) (obj));
		super.GB = 112;
		...
		arraycopy(n, super.view_scale, 3, 12, 159, 24, imagepixels1, 32, 0, 32);
		obj = k2++;
		super.AB = "Loading And Preparing Resources";
		super.EB = ((int) (obj));
		super.GB = 112;
		...
		arraycopy(o, super.view_scale, 3, 44, 55, 32, imagepixels1, 32, 0, 32);
		obj = k2++;
		super.AB = "Loading And Preparing Resources";
		super.EB = ((int) (obj));
		super.GB = 112;
		...
		arraycopy(p, super.view_scale, 3, 47, 96, 45, imagepixels1, 32, 0, 32);
		obj = k2++;
		super.AB = "Loading And Preparing Resources";
		super.EB = ((int) (obj));
		super.GB = 112;
		...
		arraycopy(q, super.view_scale, 3, 47, 148, 34, imagepixels1, 32, 0, 32);
		obj = k2++;
		super.AB = "Loading And Preparing Resources";
		super.EB = ((int) (obj));
		super.GB = 112;
		...
		arraycopy(r, super.view_scale, 3, 95, 8, 51, imagepixels1, 32, 0, 32);
		obj = k2++;
		super.AB = "Loading And Preparing Resources";
		super.EB = ((int) (obj));
		super.GB = 112;
		...
		arraycopy(t, super.view_scale, 3, 152, 10, 44, imagepixels1, 32, 0, 32);
		obj = k2++;
		super.AB = "Loading And Preparing Resources";
		super.EB = ((int) (obj));
		super.GB = 112;
		...
		arraycopy(u, super.view_scale, 3, 150, 125, 46, imagepixels1, 32, 0, 32);
		obj = k2++;
		super.AB = "Loading And Preparing Resources";
		super.EB = ((int) (obj));
		super.GB = 112;
		...
		arraycopy(v, super.view_scale, 3, 8, 192, 48, imagepixels1, 32, 0, 32);
		obj = k2++;
		super.AB = "Loading And Preparing Resources";
		super.EB = ((int) (obj));
		super.GB = 112;
		...
		arraycopy(w, super.view_scale, 3, 390, 169, 86, imagepixels1, 32, 0, 32);
		obj = k2++;
		super.AB = "Loading And Preparing Resources";
		super.EB = ((int) (obj));
		super.GB = 112;
		...
		append(II, super.view_scale, 0.0F, 0, 244, 136, 112, imagepixels1);
		FI = new sprite_group(this, 64, 1);
		FI.I(super.view_scale, 3, 33, 32, 100, 133, 6, 0, imagepixels1, 64, 0, 64, super.lC);
		ZI = new sprite_group(this, 1);
		append(ZI, super.view_scale, 0.0F, 0, 125, 172, 49, imagepixels1);
		CI = new sprite_group(this, 1);
		append(CI, super.view_scale, 0.0F, 0, 181, 174, 46, imagepixels1);
		BI = new sprite_group(this, 1);
		append(BI, super.view_scale, 0.0F, 0, 120, 223, 36, imagepixels1);
		DI = new sprite_group(this, 1);
		append(DI, super.view_scale, 0.0F, 0, 186, 224, 32, imagepixels1);
		obj = k2++;
		super.AB = "Loading And Preparing Resources";
		super.EB = ((int) (obj));
		super.GB = 112;
		...
		append(JI, super.view_scale, 0.0F, 0, 450, 8, 240, imagepixels1);
		SI = new sprite_group(this, 1);
		append(SI, super.view_scale, 0.0F, 0, 401, 146, 20, imagepixels1);
		AI = new sprite_group(this, 1);
		append(AI, super.view_scale, 0.0F, 0, 401, 89, 47, imagepixels1);
		EI = new sprite_group(this, 1);
		append(EI, super.view_scale, 0.0F, 0, 341, 81, 53, imagepixels1);
		GI = new sprite_group(this, 1);
		append(GI, super.view_scale, 0.0F, 0, 299, 85, 45, imagepixels1);
		obj = k2++;
		super.AB = "Loading And Preparing Resources";
		super.EB = ((int) (obj));
		super.GB = 112;
		...
		HI.I(super.view_scale, 0, 13, 10, 251, 8, 2, 0, imagepixels1, 64, 0, 64, super.lC);
		imagepixels1.Z = null;
		imagepixels1 = null;
		System.gc();
		obj = k2 += 3;
		...
		repaint();
		U = new sprite_group(this, 32, 1);
		arraycopy(U, super.view_scale, 3, 7, 60, 32, imagepixels1, 32, 0, 32);
		obj = k2++;
		super.AB = "Loading And Preparing Resources";
		super.EB = ((int) (obj));
		super.GB = 112;
		repaint();
		V = new sprite_group(this, 32, 1);
		arraycopy(V, super.view_scale, 3, 16, 98, 33, imagepixels1, 32, 0, 32);
		obj = k2++;
		super.AB = "Loading And Preparing Resources";
		super.EB = ((int) (obj));
		super.GB = 112;
		repaint();
		W = new sprite_group(this, 32, 1);
		arraycopy(W, super.view_scale, 3, 11, 136, 37, imagepixels1, 32, 0, 32);
		obj = k2++;
		super.AB = "Loading And Preparing Resources";
		super.EB = ((int) (obj));
		super.GB = 112;
		...
		arraycopy(X, super.view_scale, 3, 10, 178, 38, imagepixels1, 32, 0, 32);
		obj = k2++;
		super.AB = "Loading And Preparing Resources";
		super.EB = ((int) (obj));
		super.GB = 112;
		...
		arraycopy(Y, super.view_scale, 3, 53, 54, 41, imagepixels1, 64, 0, 64);
		obj = k2++;
		super.AB = "Loading And Preparing Resources";
		super.EB = ((int) (obj));
		super.GB = 112;
		...
		arraycopy(i, super.view_scale, 3, 55, 105, 46, imagepixels1, 32, 0, 32);
		obj = k2++;
		super.AB = "Loading And Preparing Resources";
		super.EB = ((int) (obj));
		super.GB = 112;
		...
		arraycopy(z, super.view_scale, 3, 57, 151, 50, imagepixels1, 32, 0, 32);
		obj = k2++;
		super.AB = "Loading And Preparing Resources";
		super.EB = ((int) (obj));
		super.GB = 112;
		...
		arraycopy(c, super.view_scale, 3, 108, 47, 106, imagepixels1, 32, 0, 32);
		obj = k2++;
		super.AB = "Loading And Preparing Resources";
		super.EB = ((int) (obj));
		super.GB = 112;
		...
		arraycopy(b, super.view_scale, 3, 111, 159, 66, imagepixels1, 32, 0, 32);
		obj = k2++;
		super.AB = "Loading And Preparing Resources";
		super.EB = ((int) (obj));
		super.GB = 112;
		...
		arraycopy(d, super.view_scale, 3, 233, 6, 88, imagepixels1, 32, 0, 32);
		obj = k2++;
		super.AB = "Loading And Preparing Resources";
		super.EB = ((int) (obj));
		super.GB = 112;
		...
		arraycopy(f, super.view_scale, 3, 228, 117, 104, imagepixels1, 32, 0, 32);
		obj = k2++;
		super.AB = "Loading And Preparing Resources";
		super.EB = ((int) (obj));
		super.GB = 112;
		...
		append(j, super.view_scale, 0.0F, 0, 322, 5, 108, imagepixels1);
		s = new sprite_group(this, 1);
		append(s, super.view_scale, 0.0F, 0, 400, 126, 25, imagepixels1);
		a = new sprite_group(this, 1);
		append(a, super.view_scale, 0.0F, 0, 426, 126, 25, imagepixels1);
		e = new sprite_group(this, 1);
		append(e, super.view_scale, 0.0F, 0, 400, 161, 17, imagepixels1);
		g = new sprite_group(this, 1);
		append(g, super.view_scale, 0.0F, 0, 430, 160, 17, imagepixels1);
		obj = k2++;
		super.AB = "Loading And Preparing Resources";
		super.EB = ((int) (obj));
		super.GB = 112;
		...
		append(h, super.view_scale, 0.0F, 0, 460, 2, 282, imagepixels1);
		obj = k2++;
		super.AB = "Loading And Preparing Resources";
		super.EB = ((int) (obj));
		super.GB = 112;
		...
		append(F, super.view_scale, 0.0F, 0, 5, 227, 23, imagepixels1);
		append(F, super.view_scale, 0.0F, 0, 36, 227, 23, imagepixels1);
		append(F, super.view_scale, 0.0F, 0, 66, 227, 23, imagepixels1);
		append(F, super.view_scale, 0.0F, 0, 97, 227, 23, imagepixels1);
		append(F, super.view_scale, 0.0F, 0, 127, 227, 23, imagepixels1);
		append(F, super.view_scale, 0.0F, 0, 157, 227, 23, imagepixels1);
		append(F, super.view_scale, 0.0F, 0, 187, 227, 23, imagepixels1);
		append(F, super.view_scale, 0.0F, 0, 217, 227, 23, imagepixels1);
		append(F, super.view_scale, 0.0F, 0, 247, 227, 23, imagepixels1);
		append(F, super.view_scale, 0.0F, 0, 277, 227, 23, imagepixels1);
		append(F, super.view_scale, 0.0F, 0, 307, 227, 23, imagepixels1);
		append(F, super.view_scale, 0.0F, 0, 337, 227, 23, imagepixels1);
		obj = k2++;
		super.AB = "Loading And Preparing Resources";
		super.EB = ((int) (obj));
		super.GB = 112;
		...
		append(HNSM, super.view_scale, 0.0F, 0, 6, 256, 27, imagepixels1);
		append(HNSM, super.view_scale, 0.0F, 0, 37, 256, 27, imagepixels1);
		append(HNSM, super.view_scale, 0.0F, 0, 67, 256, 27, imagepixels1);
		append(HNSM, super.view_scale, 0.0F, 0, 97, 256, 27, imagepixels1);
		append(HNSM, super.view_scale, 0.0F, 0, 127, 256, 27, imagepixels1);
		append(HNSM, super.view_scale, 0.0F, 0, 157, 256, 27, imagepixels1);
		append(HNSM, super.view_scale, 0.0F, 0, 186, 256, 27, imagepixels1);
		append(HNSM, super.view_scale, 0.0F, 0, 216, 256, 27, imagepixels1);
		append(HNSM, super.view_scale, 0.0F, 0, 247, 256, 27, imagepixels1);
		append(HNSM, super.view_scale, 0.0F, 0, 276, 256, 27, imagepixels1);
		append(HNSM, super.view_scale, 0.0F, 0, 306, 256, 27, imagepixels1);
		append(HNSM, super.view_scale, 0.0F, 0, 336, 256, 27, imagepixels1);
		obj = k2++;
		super.AB = "Loading And Preparing Resources";
		super.EB = ((int) (obj));
		super.GB = 112;
		...
		abs.I(super.view_scale, 0, 13, 10, 133, 5, 2, 0, imagepixels1, 64, 0, 64, super.lC);
		KI = new sprite_group(this, 64, 1);
		KI.I(super.view_scale, 0, 14, 11, 132, 26, 2, 0, imagepixels1, 64, 0, 64, super.lC);
		imagepixels1.Z = null;
		imagepixels1 = null;
		System.gc();
		float f2 = k2 += 3;
		...
		hI.I(super.view_scale, 0, 36, 30, 35, 691, 0, 0, imagepixels1, 16, 0, 16, super.lC);
		...
		append(sStarWhite, super.view_scale * 0.55F, 0.0F, 0, 5, 702, 30, imagepixels1);
		append(sStarWhite, super.view_scale * 0.55F, 0.0F, 0, 32, 702, 30, imagepixels1);
		append(sStarWhite, super.view_scale * 0.55F, 0.0F, 0, 58, 702, 30, imagepixels1);
		sStarRed = new sprite_group(this, 3);
		append(sStarRed, super.view_scale * 0.55F, 0.0F, 0, 5, 734, 30, imagepixels1);
		append(sStarRed, super.view_scale * 0.55F, 0.0F, 0, 32, 734, 30, imagepixels1);
		append(sStarRed, super.view_scale * 0.55F, 0.0F, 0, 58, 734, 30, imagepixels1);
		sStarBlue = new sprite_group(this, 3);
		append(sStarBlue, super.view_scale * 0.55F, 0.0F, 0, 5, 764, 30, imagepixels1);
		append(sStarBlue, super.view_scale * 0.55F, 0.0F, 0, 32, 764, 30, imagepixels1);
		append(sStarBlue, super.view_scale * 0.55F, 0.0F, 0, 58, 764, 30, imagepixels1);
		// gameimagelist1 = k2++;
		super.AB = "Loading And Preparing Resources";
		super.EB = k2 - 1;
		super.GB = 112;
		...
		obj2 = I;
		f4 = super.view_scale * 0.12F;
		surface1 = super.lC;
		sprite.I(f4, 0.0F, 0, 115, 107, 509, 6, 0, 0, imagepixels1, surface1, this);
		((sprite_group) (obj2)).I(0, (int) f4);
		obj2 = I;
		f4 = super.view_scale * 0.14F;
		surface1 = super.lC;
		sprite.I(f4, 0.0F, 0, 115, 107, 509, 6, 0, 0, imagepixels1, surface1, this);
		((sprite_group) (obj2)).I(0, (int) f4);
		obj2 = I;
		f4 = super.view_scale * 0.17F;
		surface1 = super.lC;
		sprite.I(f4, 0.0F, 0, 115, 107, 509, 6, 0, 0, imagepixels1, surface1, this);
		((sprite_group) (obj2)).I(0, (int) f4);
		obj2 = I;
		f4 = super.view_scale * 0.21F;
		surface1 = super.lC;
		sprite.I(f4, 0.0F, 0, 115, 107, 509, 6, 0, 0, imagepixels1, surface1, this);
		((sprite_group) (obj2)).I(0, (int) f4);
		obj2 = I;
		f4 = super.view_scale * 0.26F;
		surface1 = super.lC;
		sprite.I(f4, 0.0F, 0, 115, 107, 509, 6, 0, 0, imagepixels1, surface1, this);
		((sprite_group) (obj2)).I(0, (int) f4);
		obj2 = I;
		f4 = super.view_scale * 0.32F;
		surface1 = super.lC;
		sprite.I(f4, 0.0F, 0, 115, 107, 509, 6, 0, 0, imagepixels1, surface1, this);
		((sprite_group) (obj2)).I(0, (int) f4);
		...
		append(B, super.view_scale * 1.4F, 0.0F, 0, 23, 174, 79, imagepixels1);
		append(B, super.view_scale * 1.4F, 0.0F, 0, 73, 174, 79, imagepixels1);
		append(B, super.view_scale * 1.4F, 0.0F, 0, 138, 174, 79, imagepixels1);
		append(B, super.view_scale * 1.4F, 0.0F, 0, 200, 174, 79, imagepixels1);
		append(B, super.view_scale * 1.4F, 0.0F, 0, 263, 174, 79, imagepixels1);
		append(B, super.view_scale * 1.4F, 0.0F, 0, 330, 174, 79, imagepixels1);
		append(B, super.view_scale * 1.4F, 0.0F, 0, 395, 174, 79, imagepixels1);
		append(B, super.view_scale * 1.4F, 0.0F, 0, 461, 174, 79, imagepixels1);
		append(B, super.view_scale * 1.4F, 0.0F, 0, 525, 174, 79, imagepixels1);
		append(B, super.view_scale * 1.4F, 0.0F, 0, 590, 174, 79, imagepixels1);
		append(B, super.view_scale * 1.4F, 0.0F, 0, 656, 174, 79, imagepixels1);
		append(B, super.view_scale * 1.4F, 0.0F, 0, 721, 174, 79, imagepixels1);
		append(B, super.view_scale * 1.4F, 0.0F, 0, 786, 174, 79, imagepixels1);
		append(B, super.view_scale * 1.4F, 0.0F, 0, 852, 174, 79, imagepixels1);
		D = new sprite_group(this, 8);
		append(D, super.view_scale * 1.2F, 0.0F, 0, 29, 265, 106, imagepixels1);
		append(D, super.view_scale * 1.2F, 0.0F, 0, 130, 265, 106, imagepixels1);
		append(D, super.view_scale * 1.2F, 0.0F, 0, 240, 265, 106, imagepixels1);
		append(D, super.view_scale * 1.2F, 0.0F, 0, 354, 265, 106, imagepixels1);
		append(D, super.view_scale * 1.2F, 0.0F, 0, 467, 265, 106, imagepixels1);
		append(D, super.view_scale * 1.2F, 0.0F, 0, 584, 265, 106, imagepixels1);
		append(D, super.view_scale * 1.2F, 0.0F, 0, 711, 265, 106, imagepixels1);
		append(D, super.view_scale * 1.2F, 0.0F, 0, 873, 265, 106, imagepixels1);
		obj2 = k2++;
		super.AB = "Loading And Preparing Resources";
		super.EB = ((int) (obj2));
		super.GB = 112;
		...
		append(S, super.view_scale * 0.4F, 0.0F, 0, 23, 174, 79, imagepixels1);
		append(S, super.view_scale * 0.4F, 0.0F, 0, 73, 174, 79, imagepixels1);
		append(S, super.view_scale * 0.4F, 0.0F, 0, 138, 174, 79, imagepixels1);
		append(S, super.view_scale * 0.4F, 0.0F, 0, 200, 174, 79, imagepixels1);
		append(S, super.view_scale * 0.4F, 0.0F, 0, 263, 174, 79, imagepixels1);
		append(S, super.view_scale * 0.4F, 0.0F, 0, 330, 174, 79, imagepixels1);
		append(S, super.view_scale * 0.4F, 0.0F, 0, 395, 174, 79, imagepixels1);
		append(S, super.view_scale * 0.4F, 0.0F, 0, 461, 174, 79, imagepixels1);
		append(S, super.view_scale * 0.4F, 0.0F, 0, 525, 174, 79, imagepixels1);
		append(S, super.view_scale * 0.4F, 0.0F, 0, 590, 174, 79, imagepixels1);
		append(S, super.view_scale * 0.4F, 0.0F, 0, 656, 174, 79, imagepixels1);
		append(S, super.view_scale * 0.4F, 0.0F, 0, 721, 174, 79, imagepixels1);
		append(S, super.view_scale * 0.4F, 0.0F, 0, 786, 174, 79, imagepixels1);
		append(S, super.view_scale * 0.4F, 0.0F, 0, 852, 174, 79, imagepixels1);
		A = new sprite_group(this, 9);
		append(A, super.view_scale * 0.4F, 0.0F, 0, 29, 265, 106, imagepixels1);
		append(A, super.view_scale * 0.4F, 0.0F, 0, 130, 265, 106, imagepixels1);
		append(A, super.view_scale * 0.4F, 0.0F, 0, 240, 265, 106, imagepixels1);
		append(A, super.view_scale * 0.4F, 0.0F, 0, 354, 265, 106, imagepixels1);
		append(A, super.view_scale * 0.4F, 0.0F, 0, 467, 265, 106, imagepixels1);
		append(A, super.view_scale * 0.4F, 0.0F, 0, 584, 265, 106, imagepixels1);
		append(A, super.view_scale * 0.4F, 0.0F, 0, 711, 265, 106, imagepixels1);
		E = new sprite_group(this, 8);
		append(E, super.view_scale, 0.0F, 0, 342, 55, 19, imagepixels1);
		append(E, super.view_scale, 0.0F, 0, 361, 55, 19, imagepixels1);
		append(E, super.view_scale, 0.0F, 0, 381, 55, 19, imagepixels1);
		append(E, super.view_scale, 0.0F, 0, 401, 55, 19, imagepixels1);
		append(E, super.view_scale, 0.0F, 0, 421, 55, 19, imagepixels1);
		append(E, super.view_scale, 0.0F, 0, 442, 55, 19, imagepixels1);
		append(E, super.view_scale, 0.0F, 0, 463, 55, 19, imagepixels1);
		append(E, super.view_scale, 0.0F, 0, 483, 55, 19, imagepixels1);
		obj2 = k2++;
		super.AB = "Loading And Preparing Resources";
		super.EB = ((int) (obj2));
		super.GB = 112;
		...
		OI.I(0, super.view_scale, 1, 17, 20, 81, 62, 0, 0, imagepixels1, 16, 0, 16, super.lC);
		MI = new sprite_group(this, 32, 6);
		MI.J = true;
		for (int k1 = 0; k1 < 32; k1++) {
			obj2 = (float) (0.098174770424681035D * (double) k1);
			f4 = super.view_scale;
			surface1 = super.lC;
		...
		for (int l1 = 0; l1 < 32; l1++) {
			obj2 = (float) (0.098174770424681035D * (double) l1);
			f4 = super.view_scale;
			surface1 = super.lC;
		...
		for (int i2 = 0; i2 < 32; i2++) {
			obj2 = (float) (0.098174770424681035D * (double) i2);
			f4 = super.view_scale;
			surface1 = super.lC;
		...
		for (int j2 = 0; j2 < 32; j2++) {
			obj2 = (float) (0.098174770424681035D * (double) j2);
			f4 = super.view_scale;
			surface1 = super.lC;
		...
		arraycopy.I(0, sprite.I(((float) (obj2 = super.view_scale)), 0.0F, 1, 40, 24, 89, 193, 0, 0, imagepixels1, temp,
				this));
		arraycopy.I(1, sprite.I(((float) (obj2 = super.view_scale)), 0.0F, 1, 40, 24, 134, 193, 0, 0, imagepixels1,
				temp, this));
		arraycopy.I(2, sprite.I(((float) (obj2 = super.view_scale)), 0.0F, 1, 40, 24, 178, 193, 0, 0, imagepixels1,
				temp, this));
		arraycopy.I(3, sprite.I(((float) (obj2 = super.view_scale)), 0.0F, 1, 40, 24, 225, 193, 0, 0, imagepixels1,
				temp, this));
		imagepixels1.Z = null;
		imagepixels1 = null;
		System.gc();
	...
	public final void blue(String s1, gamefont gamefont1, imagepixels imagepixels1, float f1, int i1, int j1, int k1,
		...
		for (int k2 = 0; k2 < j2; k2++) {
			...
			int i2 = Math.round((float) (((rectangle.y - j1) + rectangle.height) - l1) * f1);
			int l2 = rectangle.width;
			int i3 = rectangle.height;
			int j3 = rectangle.x;
			int k3 = rectangle.y;
	...
	final void brighter() {
		...
		for (int k2 = 0; k2 < getRuntime.I; k2++) {
			oGameObject oGameObject1 = new oGameObject(this);
	...
	final oGameObject I(int i1, int j1, int k1, int l1, int i2) {
		if (i1 == -1 || i1 == 2) {
			oGameObjectlist oGameObjectlist1 = wZ;
			oGameObject oGameObject1 = oGameObjectlist1.I(1, j1, k1, l1, i2, -1F);
			if (oGameObject1 != null)
				return oGameObject1;
		}
		if (i1 == -1 || i1 == 1) {
			oGameObjectlist oGameObjectlist2 = dZ;
			oGameObject oGameObject2 = oGameObjectlist2.I(1, j1, k1, l1, i2, -1F);
		...
		if (i2 != -1) {
			...
			oGameObject oGameObject3 = oGameObjectlist3.I(1, j1, k1, l1, i2, -1F);
