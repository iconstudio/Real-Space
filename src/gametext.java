...
final class gametext extends oGameObject
{
    ...
    final void I(String s, Color color, gamefont gamefont1, boolean flag, int i, int j, int k, 
            int l, int i1, boolean flag1)
    {
        if(gamefont1 == null)
            return;
            ...
            for(int i1 = XI[i]; i3 < k1 && i1 < min && i1 < HNSM; i3++)
            {
                ...
                if(sprite1 != null)
                {
                    if(B != null || LI != null)
                    {
                        ...
                        surface1.I(sprite1, k2, k3 - 1, (k - sprite1.B) + (c <= 0 || c >= gamefont.D ? 0 : gamefont5.Z[c]) + 1, super.owner);
                    }
                    if(getRGB && D != null)
                        if(min > HNSM + D.C)
                            i2 = D.I(toCharArray, I);
                    ...
                    surface1.I(sprite1, i2, k3, (k - sprite1.B) + (c <= 0 || c >= gamefont.D ? 0 : gamefont6.Z[c]), super.owner);
                    k3 += sprite1.C + RI.B;
                } else
                if(c == ' ')
                    k3 += RI.B * 2;
