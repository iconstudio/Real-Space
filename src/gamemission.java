...
final class gamemission {
	...
	final void I(int i) {
		...
		case 1101:
			...
			gamefont gamefont1 = ((gamebase) (owner)).hFontSmall;
		...
		case 1100:
			...
			show_flashstring(-1, "Objectives Failed||Aborting Mission", ((palette) (obj1)), ((palette) (obj10)),
					((gamefont) (obj19)), true, l1, i2, 0, 150, 0, true, true, 1, -1, 0);
			lightGray(100);
			obj1 = B + "|Has Been Destroyed!";
			obj10 = owner.flashcolor_white;
			obj19 = owner.flashcolor_navy;
			gamefont gamefont7 = ((gamebase) (owner)).hFontNormal;
			...
			F(-1, "Game Over", ((Color) (obj1)), ((Color) (obj10)), ((gamefont) (obj19)), true, j1, k1, 0, 300, 0, true,
		...
		case 1102:
			...
			gamefont gamefont2 = ((gamebase) (owner)).hFontSmall;
		...
		case 1001:
			...
			show_flashstring(3, ((String) (obj3)), palette, ((palette) (obj20)), ((gamefont) (obj30)), true, l2, i3, 0,
					10000, 0, true, false, 0, -1, 0);
			lightGray(10);
			obj3 = owner.flashcolor_yellow;
			palette = owner.flashcolor_red;
			obj20 = ((gamebase) (owner)).hFontNormal;
			show_flashstring(-1, "The Terrans Invaded", ((palette) (obj3)), palette, ((gamefont) (obj20)), true, j, k,
			...
			gray(1, 60, 123, 1.5F);
			lightGray(1, 100, 5, 1);
			Z(1, ((gamebase) (owner)).YC + (int) ((double) ((gamebase) (owner)).sC * 0.10000000000000001D),
					((gamebase) (owner)).zC + (int) ((double) ((gamebase) (owner)).aC * 0.10000000000000001D),
			...
			gray(2, 100, 223, 6F);
			lightGray(2, 90, 5, 1);
			Z(2, ((gamebase) (owner)).YC + (int) ((double) ((gamebase) (owner)).sC * 0.10000000000000001D),
					((gamebase) (owner)).zC + (int) ((double) ((gamebase) (owner)).aC * 0.10000000000000001D),
					(int) (((gamebase) (owner)).sC * 0.8F), (int) (((gamebase) (owner)).aC * 0.8F));
			abs();
			lightGray(70);
			...
			show_flashstring(-1, "We Struck Back", ((palette) (obj20)), ((palette) (obj30)), ((gamefont) (obj39)), true,
					j, k, 0, 70, 0, true, true, 0, -1, 0);
			lightGray(80);
			obj20 = ((gamebase) (owner)).DB + " Presents";
			obj30 = owner.flashcolor_white;
			obj39 = owner.flashcolor_navy;
			gamefont gamefont16 = ((gamebase) (owner)).hFontNormal;
			...
			show_flashstring(-1, "Realspace 2 - Emperor's Revenge", ((palette) (obj20)), ((palette) (obj30)),
					((gamefont) (obj39)), true, j, k, 0, 200, 0, true, true, 0, -1, 0);
			lightGray(40);
			obj20 = owner.flashcolor_yellow;
			obj30 = owner.flashcolor_red;
			obj39 = ((gamebase) (owner)).hFontSmall;
			int i4 = j + 50;
			@SuppressWarnings("unused") gamefont gamefont27;
			...
			show_flashstring(-1, "Copyright 2001 AltoParc|www.altoparc.com", ((palette) (obj20)), ((palette) (obj30)),
					((gamefont) (obj39)), true, i4, j4, 0, 165, 0, true, true, 0, -1, 0);
			lightGray(170);
			obj20 = owner.flashcolor_yellow;
			obj30 = owner.flashcolor_red;
			obj39 = ((gamebase) (owner)).hFontNormal;
			show_flashstring(-1, "We Smashed The Terran Frontier", ((palette) (obj20)), ((palette) (obj30)),
					((gamefont) (obj39)), true, j, k, 0, 70, 0, true, true, 0, -1, 0);
			lightGray(80);
			obj20 = owner.flashcolor_yellow;
			obj30 = owner.flashcolor_red;
			obj39 = ((gamebase) (owner)).hFontNormal;
			...
			show_flashstring(-1, "Apocalypse Outpost Stopped Us", ((palette) (obj20)), ((palette) (obj30)),
					((gamefont) (obj39)), true, j, k, 0, 100, 0, true, true, 0, -1, 0);
			lightGray(110);
			obj20 = owner.flashcolor_yellow;
			obj30 = owner.flashcolor_red;
			obj39 = ((gamebase) (owner)).hFontNormal;
			...
			show_flashstring(-1, "They Attacked And Destroyed All|Worlds That Would Not Succumb", ((palette) (obj20)),
					((palette) (obj30)), ((gamefont) (obj39)), true, j, k, 0, 140, 0, true, true, 0, -1, 0);
			lightGray(150);
			obj20 = owner.flashcolor_yellow;
			obj30 = owner.flashcolor_red;
			obj39 = ((gamebase) (owner)).hFontNormal;
			...
			show_flashstring(-1, "The Emperor And The Katuri|People Demand Revenge!", ((palette) (obj20)),
					((palette) (obj30)), ((gamefont) (obj39)), true, j, k, 0, 150, 0, true, true, 0, -1, 0);
			lightGray(160);
			obj20 = owner.flashcolor_yellow;
			obj30 = owner.flashcolor_red;
			obj39 = ((gamebase) (owner)).hFontNormal;
			...
			show_flashstring(-1, "And Exact Our Revenge By Destroying|Their Homeworld... The Earth!",
					((palette) (obj20)), ((palette) (obj30)), ((gamefont) (obj39)), true, j, k, 0, 200, 0, true, true,
					0, -1, 0);
			lightGray(250);
			obj20 = owner.flashcolor_white;
			obj30 = owner.flashcolor_navy;
			...
			obj30 = owner.flashcolor_navy;
			obj39 = ((gamebase) (owner)).hFontNormal;
			show_flashstring(-1, "Music||Jason Graves", ((palette) (obj20)), ((palette) (obj30)), ((gamefont) (obj39)),
		...
		case 300:
			...
			show_flashstring(-1, "Choose One Of The Following", ((palette) (obj12)), ((palette) (obj21)),
					((gamefont) (obj31)), true, j, j3, 0, 1000, 0, true, false, 0, -1, 0);
			obj12 = ((gamebase) (owner)).hFontSmall;
			j3 += ((gamefont) (obj12)).C + (int) (35F * ((gamebase) (owner)).view_scale);
			obj12 = owner.flashcolor_white;
			obj21 = owner.flashcolor_navy;
			obj31 = ((gamebase) (owner)).hFontNormal;
			show_flashstring(1, "Start Game", ((palette) (obj12)), ((palette) (obj21)), ((gamefont) (obj31)), true, j,
					j3, 0, 1000, 0, true, false, 0, -1, 0);
			obj12 = ((gamebase) (owner)).hFontNormal;
			j3 += ((gamefont) (obj12)).C + (int) (20F * ((gamebase) (owner)).view_scale);
			...
			show_flashstring(2, ((String) (obj12)), ((palette) (obj21)), ((palette) (obj31)), ((gamefont) (obj40)),
					true, j, j3, 0, 1000, 0, true, false, 0, -1, 0);
			obj21 = ((gamebase) (owner)).hFontNormal;
			j3 += ((gamefont) (obj21)).C * 2 + (int) (20F * ((gamebase) (owner)).view_scale);
			obj21 = "Visit " + ((gamebase) (owner)).DB;
			obj31 = owner.flashcolor_white;
			obj40 = owner.flashcolor_navy;
			gamefont gamefont17 = ((gamebase) (owner)).hFontNormal;
			...
			show_flashstring(4, "Return To Demo Mode", ((palette) (obj21)), ((palette) (obj31)), ((gamefont) (obj40)),
					true, j, j3, 0, 1000, 0, true, false, 0, -1, 0);
			max();
			lightGray(1000);
			blue();
		...
		case 301:
			...
			gamefont gamefont8 = ((gamebase) (owner)).hFontLarge;
			...
			k3 += ((gamefont) (obj13)).C + (int) (35F * ((gamebase) (owner)).view_scale);
			...
			k3 += ((gamefont) (obj13)).C + (int) (20F * ((gamebase) (owner)).view_scale);
			obj13 = owner.flashcolor_white;
			palette1 = owner.flashcolor_navy;
			gamefont8 = ((gamebase) (owner)).hFontNormal;
			...
			show_flashstring(4, "Blitzkrieg", ((palette) (obj13)), palette1, gamefont8, true, j, k3, 0, 1000, 0, true,
					false, 0, -1, 0);
			obj13 = ((gamebase) (owner)).hFontNormal;
			k3 += ((gamefont) (obj13)).C * 2 + (int) (20F * ((gamebase) (owner)).view_scale);
			obj13 = owner.flashcolor_white;
			palette1 = owner.flashcolor_navy;
			gamefont8 = ((gamebase) (owner)).hFontNormal;
		...
		case 302:
			...
			l3 += ((gamefont) (obj14)).C + (int) (20F * ((gamebase) (owner)).view_scale);
			obj14 = owner.flashcolor_white;
			palette2 = owner.flashcolor_navy;
			gamefont9 = ((gamebase) (owner)).hFontNormal;
			...
			show_flashstring(3, "Low", ((palette) (obj14)), palette2, gamefont9, true, j, l3, 0, 1000, 0, true, false,
					0, -1, 0);
			obj14 = ((gamebase) (owner)).hFontNormal;
			l3 += ((gamefont) (obj14)).C * 2 + (int) (20F * ((gamebase) (owner)).view_scale);
			obj14 = owner.flashcolor_white;
			palette2 = owner.flashcolor_navy;
			gamefont9 = ((gamebase) (owner)).hFontNormal;
		...
		case 101: // 'e'
			...
			show_flashstring(-1, "Mission One - Defilers", palette11, palette16, ((gamefont) (obj46)), true, l, i1, 0,
			...
			show_flashstring(10, "Skip Intro", palette11, palette16, ((gamefont) (obj46)), true, j2, k2, 0, 10000, 0,
					true, false, 0, -1, 0);
			lightGray(10);
			...
			show_flashstring(-1, "Sirius Prime - The Katuri Homeworld", temp_palette_1, temp_palette_2,
					((gamefont) (obj46)), false, 0, 0, 0, 120, 0, true, true, 1, 100, 2);
			lightGray(130);
			...
			obj46 = ((gamebase) (owner)).hFontNormal;
			show_flashstring(-1, "Jump Signatures Detected", temp_palette_1, temp_palette_2, ((gamefont) (obj46)), true,
			...
			show_flashstring(-1, "It's The United Fleet!||The Dogs Mean To End The War", temp_palette_2,
					((palette) (obj46)), ((gamefont) (obj47)), true, j1, k1, 0, 100, 0, true, true, 1, -1, 0);
			lightGray(20);
			...
			show_flashstring(-1, "All Remaining Forces... Attack!", temp_palette_1, ((palette) (obj47)),
					((gamefont) (obj48)), true, j1, k1, 0, 100, 0, true, true, 1, -1, 0);
			lightGray(50);
			...
			show_flashstring(-1, "Keep Them From The Homeworld||For The Glory Of The Emperor!", temp_palette_1,
					temp_palette_2, ((gamefont) (obj48)), true, j1, k1, 0, 130, 0, true, true, 1, -1, 0);
			lightGray(180);
			...
			temp_palette_2 = owner.flashcolor_red;
			obj48 = ((gamebase) (owner)).hFontNormal;
			show_flashstring(-1, "We Need Re-Enforcments Now!", temp_palette_1, temp_palette_2, ((gamefont) (obj48)),
			...
			temp_palette_2 = owner.flashcolor_red;
			obj48 = ((gamebase) (owner)).hFontNormal;
			show_flashstring(-1, "The Homeworld Is Defenseless", temp_palette_1, temp_palette_2, ((gamefont) (obj48)), true, j1, k1, 0, 100,
					0, true, true, 1, -1, 0);
			lightGray(120);
			temp_palette_1 = owner.flashcolor_yellow;
			temp_palette_2 = owner.flashcolor_red;
			obj48 = ((gamebase) (owner)).hFontLarge;
			show_flashstring(-1, "United Fleet...||We Surrender", temp_palette_1, temp_palette_2, ((gamefont) (obj48)), true, j1, k1, 0, 70,
					0, true, true, 1, -1, 0);
			lightGray(60);
			compareTo(true);
			lightGray(30);
			...
			temp_palette_2 = owner.flashcolor_red;
			obj48 = ((gamebase) (owner)).hFontNormal;
			show_flashstring(-1, "Stop Attacking||Somebody... Anybody... Help!", temp_palette_1, temp_palette_2, ((gamefont) (obj48)), true,
					j1, k1, 0, 90, 0, true, true, 1, -1, 0);
			lightGray(60);
			f68 = f - 200F * ((gamebase) (owner)).view_scale;
			...
			show_flashstring(-1, "More Jump Signatures Detected||It's Ours... star_blinking Wing Of Suicide Bombers!",
					temp_palette_1, temp_palette_2, ((gamefont) (obj48)), true, j1, k1, 0, 120, 0, true, true, 1, -1, 0);
			lightGray(10);
			...
			temp_palette_1 = owner.flashcolor_yellow;
			temp_palette_2 = owner.flashcolor_red;
			gamefont gamefont30 = ((gamebase) (owner)).hFontNormal;
			show_flashstring(-1, "The United Fleet Dogs Are Retreating", temp_palette_1, temp_palette_2, gamefont30, true, j1, k1, 0, 80, 0,
					true, true, 1, -1, 0);
			lightGray(40);
			f71 = f + 600F * ((gamebase) (owner)).view_scale;
			f73 = f19 - 600F * ((gamebase) (owner)).view_scale;
		...
		case 102: // 'f'
			...
			gamefont gamefont10 = ((gamebase) (owner)).hFontNormal;
			show_flashstring(-1, "Re-Enforcements Have Arrived", temp_palette_1, ((palette) (obj32)), gamefont10, true, j1, k1, 0,
					80, 0, true, true, 1, -1, 0);
			...
			show_flashstring(-1, "KFS Vengeance", temp_palette_1, ((palette) (obj32)), gamefont10, false, 0, 0, 0, 80, 0, true,
					true, 1, 101, 2);
			lightGray(40);
			abs();
			temp_palette_1 = owner.flashcolor_yellow;
			...
			show_flashstring(-1,
					"Protect These Ships Until|More Re-Enforcements Arrive.||Atleast One Ship Must Survive!", temp_palette_1,
					((palette) (obj32)), gamefont10, true, j1, k1, 0, 200, 0, true, true, 1, -1, 0);
			gray(2, 120, 201, 5.5F + 0.4F * (float) Q);
			lightGray(2, Math.max(70 + -4 * Q, 23), 5, 1);
			lightGray(150);
			gray(2, 100, 202, 5.5F + 0.4F * (float) Q);
			lightGray(2, Math.max(120 + -5 * Q, 40), 10, 2);
			lightGray(300);
			gray(2, 100, 211, 3.5F + 0.4F * (float) Q);
			...
			show_flashstring(-1, "All Clear!", temp_palette_1, ((palette) (obj32)), gamefont10, true, j1, k1, 0, 90, 0, true,
					false, 0, -1, 0);
		...
		case 110: // 'n'
			...
			gamefont gamefont11 = ((gamebase) (owner)).hFontLarge;
			...
			temp_palette_2 = owner.flashcolor_red;
			gamefont11 = ((gamebase) (owner)).hFontNormal;
			show_flashstring(-1, "Additional Re-Enforcements Have Arrived", temp_palette_1, temp_palette_2, gamefont11, true, j1, k1, 0, 80,
					0, true, true, 1, -1, 0);
			lightGray(90);
			temp_palette_1 = owner.flashcolor_yellow;
			temp_palette_2 = owner.flashcolor_red;
		...
		case 111: // 'o'
			...
			gamefont gamefont3 = ((gamebase) (owner)).hFontNormal;
			show_flashstring(-1,
			...
			gray(2, 200, 203, 5.5F + 0.4F * (float) Q);
			gray(2, 100, 201, 5.5F + 0.4F * (float) Q);
		...
		case 120: // 'x'
			...
			gamefont gamefont31 = ((gamebase) (owner)).hFontLarge;
			show_flashstring(-1, "Mission Three - System's Edge", temp_palette_1, temp_palette_2, gamefont31, true, l, i1, 0, 80, 0,
					true, false, 0, -1, 0);
			getName(owner.NZ, owner.zZ, false);
			temp_palette_1 = owner.flashcolor_white;
			temp_palette_2 = owner.flashcolor_navy;
			gamefont31 = ((gamebase) (owner)).hFontNormal;
			show_flashstring(10, "Skip Intro", temp_palette_1, temp_palette_2, gamefont31, true, j2, k2, 0, 10000, 0, true, false, 0,
					-1, 0);
			lightGray(10);
			...
			temp_palette_2 = owner.flashcolor_red;
			gamefont31 = ((gamebase) (owner)).hFontNormal;
			show_flashstring(-1, "This United Fleet Outpost On The|Edge Of The System Must Be Destroyed", temp_palette_1,
					temp_palette_2, gamefont31, true, j1, k1, 0, 160, 0, true, true, 1, -1, 0);
			lightGray(80);
			...
			temp_palette_2 = owner.flashcolor_red;
			gamefont31 = ((gamebase) (owner)).hFontNormal;
			show_flashstring(-1, "Jump Signatures Detected", temp_palette_1, temp_palette_2, gamefont31, true, j1, k1, 0, 70, 0, true,
					true, 1, -1, 0);
			lightGray(80);
			temp_palette_1 = owner.flashcolor_yellow;
			temp_palette_2 = owner.flashcolor_red;
			gamefont31 = ((gamebase) (owner)).hFontNormal;
			show_flashstring(-1, "The United Fleet Is Attempting|To Re-Enforce Their Outpost", temp_palette_1, temp_palette_2,
					gamefont31, true, j1, k1, 0, 110, 0, true, true, 1, -1, 0);
			lightGray(60);
			...
			temp_palette_2 = owner.flashcolor_red;
			gamefont31 = ((gamebase) (owner)).hFontNormal;
			show_flashstring(-1, "Joining Us Are More Ships", temp_palette_1, temp_palette_2, gamefont31, true, j1, k1, 0, 80, 0, true,
					true, 1, -1, 0);
			lightGray(50);
			lightGray(101, false);
			lightGray(40);
		...
		case 121: // 'y'
			...
			gamefont gamefont12 = ((gamebase) (owner)).hFontNormal;
			show_flashstring(-1,
			...
			show_flashstring(-1, "All Clear!", temp_palette_1, temp_palette_2, gamefont12, true, j1, k1, 0, 90, 0, true, false, 0, -1, 0);
			getName(owner.NZ, owner.cZ, false);
			lightGray(20);
			random(1);
			lightGray(80);
		...
		case 130:
			...
			show_flashstring(-1, "Mission Four - Transport Alley", ((palette) (obj25)), palette5, ((gamefont) (obj41)),
			...
			show_flashstring(10, "Skip Intro", ((palette) (obj25)), palette5, ((gamefont) (obj41)), true, j2, k2, 0,
					10000, 0, true, false, 0, -1, 0);
			lightGray(10);
			...
			obj41 = ((gamebase) (owner)).hFontNormal;
			show_flashstring(-1, "Entering The Wolf 359 System", ((palette) (obj25)), palette5, ((gamefont) (obj41)),
			...
			gamefont gamefont18 = ((gamebase) (owner)).hFontNormal;
			show_flashstring(-1,
		...
		case 131:
			...
			gamefont gamefont13 = ((gamebase) (owner)).hFontNormal;
			show_flashstring(-1,
			...
			HNSM(1, -1, -1, -1, -1, 4F);
			abs();
			gray(2, 100, 210, 4F + 0.4F * (float) Q);
			lightGray(2, Math.max(70 + -4 * Q, 23), 5, 1);
			lightGray(300);
		...
		case 132:
			...
			gamefont gamefont4 = ((gamebase) (owner)).hFontSmall;
		...
		case 140:
			...
			gamefont gamefont19 = ((gamebase) (owner)).hFontLarge;
		...
		case 141:
			...
			gamefont gamefont5 = ((gamebase) (owner)).hFontNormal;
			...
			lightGray(101, true);
			abs();
			gray(2, 100, 212, 4F + 0.4F * (float) Q);
			gray(2, 100, 203, 4F + 0.4F * (float) Q);
			gray(2, 100, 202, 4F + 0.4F * (float) Q);
			gray(2, 100, 211, 4F + 0.4F * (float) Q);
			lightGray(2, Math.max(90 + -4 * Q, 30), 5, 1);
			lightGray(300);
			gray(2, 150, 213, 4F + 0.4F * (float) Q);
			lightGray(2, Math.max(80 + -3 * Q, 26), 10, 1);
			lightGray(400);
			gray(2, 200, 220, 4F + 0.4F * (float) Q);
		...
		case 150:
			...
			gamefont gamefont14 = ((gamebase) (owner)).hFontLarge;
		...
		case 151:
			...
			gamefont gamefont20 = ((gamebase) (owner)).hFontNormal;
			show_flashstring(-1,
			...
			abs();
			gray(2, 100, 220, 4F + 0.4F * (float) Q);
			gray(2, 80, 221, 4F + 0.4F * (float) Q);
			gray(2, 100, 222, 4F + 0.4F * (float) Q);
			gray(2, 100, 213, 4F + 0.4F * (float) Q);
			gray(2, 100, 212, 4F + 0.4F * (float) Q);
			gray(2, 100, 202, 4F + 0.4F * (float) Q);
			lightGray(2, Math.max(70 + -4 * Q, 23), 5, 1);
			lightGray(300);
		...
		case 160:
			...
			gamefont gamefont21 = ((gamebase) (owner)).hFontLarge;
		...
		case 161:
			...
			gamefont gamefont22 = ((gamebase) (owner)).hFontNormal;
			show_flashstring(-1,
			...
			gray(2, 100, 222, 3F + 0.4F * (float) Q);
			gray(2, 100, 213, 3.5F + 0.4F * (float) Q);
			gray(2, 100, 212, 3.5F + 0.4F * (float) Q);
			gray(2, 100, 202, 4.5F + 0.4F * (float) Q);
		...
		case 162:
			...
			gamefont gamefont6 = ((gamebase) (owner)).hFontSmall;
		...
		case 170:
			...
			gamefont gamefont15 = ((gamebase) (owner)).hFontLarge;
		...
		case 171:
			...
			gamefont gamefont23 = ((gamebase) (owner)).hFontNormal;
			...
			abs();
			gray(2, 150, 223, 4F + 0.4F * (float) Q);
			gray(2, 100, 221, 4F + 0.4F * (float) Q);
			gray(2, 100, 222, 4F + 0.4F * (float) Q);
			gray(2, 120, 212, 4F + 0.4F * (float) Q);
			gray(2, 120, 202, 4F + 0.4F * (float) Q);
		...
		case 180:
			...
			gamefont gamefont28 = ((gamebase) (owner)).hFontLarge;
		...
		case 181:
			...
			gamefont gamefont24 = ((gamebase) (owner)).hFontNormal;
		...
		case 190:
			...
			gamefont gamefont29 = ((gamebase) (owner)).hFontLarge;
		...
		case 191:
			...
			gamefont gamefont25 = ((gamebase) (owner)).hFontNormal;
			show_flashstring(-1,
		...
		case 200:
			...
			show_flashstring(-1,
					...
					((palette) (obj29)), ((palette) (obj38)), ((gamefont) (obj45)), true, j1, k1, 0, 140, 0, true, true,
					1, -1, 0);
			lightGray(50);
			...
			gamefont gamefont26 = ((gamebase) (owner)).hFontNormal;
		...
		label0: {
			label1: {
				...
				if (getName > 0) {
					compareTo--;
					if (compareTo == 0) {
						valueOf((int) (Math.random() * (double) lightGray) + 1);
						compareTo = (int) (Math.random() * (double) gray) + getName;
					}
				}
			...
			if (abs >= Z) {
				...
				case 101: // 'e'
					if (missioncmd1.E) {
						...
						oGameObjectlist obj = owner.dZ;
						oSpaceship nobj = null;
						nobj = (oSpaceship) (obj.C <= 0 ? null : ((oGameObjectlist) (obj)).Z[0]);
						if (nobj != null) {
							nobj.Z = false;
							nobj.C = 0;
							nobj.B = 0;
				...
				case 423:
					if (missioncmd1.I == 2) {
						...
						for (int l = 0; l < k2; l++) {
							oGameObjectlist oGameObjectlist11 = owner.wZ;
							oGameObject oGameObject7 = l < 0 || l >= oGameObjectlist11.C ? null : oGameObjectlist11.Z[l];
				...
				case 424:
					if (missioncmd1.I == 2) {
						...
						for (int j1 = 0; j1 < i3; j1++) {
							...
							oGameObject oGameObject9 = j1 < 0 || j1 >= oGameObjectlist15.C ? null : oGameObjectlist15.Z[j1];
					...
					for (int k1 = 0; k1 < j3; k1++) {
						...
						oGameObject oGameObject10 = k1 < 0 || k1 >= oGameObjectlist17.C ? null : oGameObjectlist17.Z[k1];
	...
	final void abs(int i, boolean flag, boolean flag1, boolean flag2, boolean flag3) {
		if (flag)
			Z(i, ((gamebase) (owner)).YC,
					((gamebase) (owner)).zC + (int) ((double) ((gamebase) (owner)).aC * 0.10000000000000001D), 0,
	...
	final void F(int i, String s, Color color, Color color1, gamefont gamefont1, boolean flag, int j, int k, int l,
	...
	final void show_flashstring(int i, String s, palette palette, palette palette1, gamefont gamefont1, boolean flag,
	...
	final void valueOf(int i) {
		for (int j4 = 0; j4 < i; j4++) {
			...
			if (k4 == 0)
				k4 = -1;
			int l4 = (int) (Math.random() * (double) println);
			for (int i5 = 0; i5 < out; i5++)
				if (l4 > random[i5]) {
					...
					case 0: // '\0'
						...
						int j1 = ((gamebase) (owner)).zC + (int) (Math.random() * (double) ((gamebase) (owner)).aC);
						int j2 = ((gamebase) (owner)).iC;
						int j3 = (int) (Math.random() * (double) (((gamebase) (owner)).aC + (float) max)) + max / 2;
						break;

					case 1: // '\001'
						int k = ((gamebase) (owner)).iC;
						int k1 = ((gamebase) (owner)).zC + (int) (Math.random() * (double) ((gamebase) (owner)).aC);
						int k2 = ((gamebase) (owner)).YC;
						int k3 = ((gamebase) (owner)).zC
								+ (int) (Math.random() * (double) (((gamebase) (owner)).aC + (float) max)) + max / 2;
						break;

					case 2: // '\002'
						int l = ((gamebase) (owner)).YC + (int) (Math.random() * (double) ((gamebase) (owner)).sC);
						int l1 = ((gamebase) (owner)).cC;
						int l2 = ((gamebase) (owner)).YC
								+ (int) (Math.random() * (double) (((gamebase) (owner)).sC + (float) max)) + max / 2;
						int l3 = ((gamebase) (owner)).YC;
						break;

					default:
						int i1 = ((gamebase) (owner)).YC + (int) (Math.random() * (double) ((gamebase) (owner)).sC);
	...
	final void F(int i, int j, float f, boolean flag, boolean flag1, int k, float f1, float f2, int l, String s) {
		...
		if (flag1) {
			...
			case 0: // '\0'
				f3 = -50F;
				f4 = (float) (Math.random() * ((double) ((gamebase) (owner)).view_height * 0.40000000000000002D) - 50D);
				break;

			case 1: // '\001'
				f3 = (float) (Math.random() * (double) ((float) ((gamebase) (owner)).view_width + 100F)) - 50F;
				f4 = -50F;
				break;

			default:
				f3 = (float) ((double) ((gamebase) (owner)).view_width + 50D);
				f4 = (float) (Math.random() * ((double) ((gamebase) (owner)).view_height * 0.40000000000000002D) - 50D);
				break;
			}
		} else {
		...
		if (flag) {
			...
			if (explosion1 != null) {
				explosion1.I(owner.sprite_group_ship, 1, (float) (int) f3 - -50F, (int) f4, 0.0F, 0.0F, 1, 2, 0, false);
				explosion1.s = -j1;
			}
		}
	...
	final void HNSM(oGameObjectlist oGameObjectlist1, float f, float f1, float f2, float f3) {
		...
		for (int j = 0; j < i; j++) {
			...
			if (((oGameObject) (oSpaceship1)).e == 3) {
				...
				explosion explosion1 = (explosion) owner.rZ.I(owner.qZ);
				if (explosion1 != null) {
					explosion1.I(owner.sprite_group_ship, 1, (float) (int) f4 - -50F, (int) f5, 0.0F, 0.0F, 1, 2, 0,
							false);
					explosion1.s = -k;
				}
				oSpaceship1.e = 1;
				if (((oGameObject) (oSpaceship1)).HI == 101) {
					oSpaceship1.Z(f4, f5, 2.0F, 0.0F, ((oGameObject) (oSpaceship1)).M, ((oGameObject) (oSpaceship1)).O, false);
					oSpaceship1.s = -10;
					oSpaceship1.QI = 4;
				} else {
					oSpaceship1.QI = 2;
					oSpaceship1.I(f4 - -50F, f5, null, f4, f5, ((oGameObject) (oSpaceship1)).M,
							((oGameObject) (oSpaceship1)).c, ((oGameObject) (oSpaceship1)).O, ((oGameObject) (oSpaceship1)).f);
					oSpaceship1.I(((oGameObject) (oSpaceship1)).J, ((oGameObject) (oSpaceship1)).S, 0.0F, 0.0F, true);
			...
			if (((oGameObject) (oSpaceship1)).e == 1) {
				...
				if (explosion1 != null)
					explosion1.I(owner.sprite_group_ship, 1,
							...
							(int) (((oGameObject) (oSpaceship1)).S + ((oGameObject) (oSpaceship1)).L * 25F), 0.0F, 0.0F, 1, 2,
							0, false);
				oSpaceship1.I(((oGameObject) (oSpaceship1)).J, ((oGameObject) (oSpaceship1)).S, ((oGameObject) (oSpaceship1)).K,
						((oGameObject) (oSpaceship1)).L, ((oGameObject) (oSpaceship1)).f);
			}
		}
	...
	final float I(float f, float f1) {
		if (f1 < 0.0F)
			return Math.max(f + f1 * (float) Q, f / 3F);
		else
			return f + f1 * (float) Q;
	}
